...
def import_binmask(
    ...
    for mask_basename, mask_path in tqdm.tqdm(mask_files.items(), unit="mask", disable=None):
        # Parse mask filename to get image name and optional label
        image_name, detected_label = parse_mask_filename(mask_basename, mask_suffix, label_name)
